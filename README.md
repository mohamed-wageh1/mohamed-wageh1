...
### `console.log("Cybersecurity Engineer")`
...
class MohamedWageh:
    def __init__(self):
        self.name = "Mohamed Wageh"
        self.role = "Cybersecurity Engineer"
        self.location = "Egypt 🇪🇬"

    def current_focus(self):
        return ["Bug Bounty", "Web Pentesting", "Linux", "Networking", "Python"]

    def previous_experience(self):
        return {
            "JavaScript": ["Node.js", "Express.js", "SQLi & XSS labs"],
            "Java & C++": ["OOP projects", "Database projects"]
        }
